...
#define SSID           "109"                   // cannot be longer than 32 characters!
#define PASSWORD       "109109109"
...
#define DEVICEID   "23072249"
#define PROJECTID "106952"
#define HOST_PORT   (80)
String apiKey="JzqKHWak0sjIQFA7KYMzXQaPGs0=";
char buf[10];
...
{   
  ...
  if (net_time1 > millis()&&humanHotState)  net_time1 = millis();
...
jsonToSend="{\"checkDoor\":";

    jsonToSend+="\""+String(millis())+"\"";
